    ...
    .then(() => {
        ...
        Products.upsert({
         ...
         Products.upsert({
            ...
            productType: "Monitor", 
            productDesc:"Elegantly designed with a smooth curved back in a classy black piano finish, supported by a robust, sturdy stand",
            quantity: 20, 
            price: 269.00, 
            discount_percentage: 0.6,
            userID: 1,
         ...
         Products.upsert({
            ...
            productType: "Monitor", 
            productDesc:"Super slim design, Extrawide viewing angle for the perfect view from anywhere, Perfectly smooth gameplay",
            quantity: 20, 
            price: 188.00, 
            discount_percentage: 0.4,
            userID: 1,
         ...
         Products.upsert({
            id: 18,
            productID: 1018, 
            productImage: "CoolMaster-MasterFan-ML120L",
            productName: "CoolerMaster MasterFan MF120L",
            productType: "Cooling Fans", 
            productDesc:"2x 120mm Red Led Fan perfectly crafted 7-blade fan design that cools your system in silence.balanced air flow and air pressure design maximizes heat reduction to keep your system cool",
            quantity: 20, 
            price: 28.00, 
            discount_percentage: 0.3,
            userID: 1,
