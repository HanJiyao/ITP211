...
exports.list=function(req,res){
    ...
    sequelize.query("select r.productID,r.helpfulness,r.rating,r.id,r.title,r.content,r.created ,u.email AS user_id from Reviews r join Users u on r.user_id=u.id ",{model:Reviews })
    .then((reviews)=>{
